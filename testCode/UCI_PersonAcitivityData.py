...
def get_new_data(clf, X_test):
    ...
    #print(group_matrix)
    for index in range(clf.get_n_leaves()):
        typical_node = []
        for res_node in group_matrix[index]:
            typical_node.append(X_test.values[res_node: res_node + 1])
        print(find_point(typical_node))
    #print(X_test)
